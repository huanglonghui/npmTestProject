  ...
  <div class="my-music">
    <div class="music-box" :key="2">
      ...
      <div class="music-list-result" v-if="listShow">
        ...
        <div v-if="searchShow">
            <li  @click="playOnline(searchResult)" style="cursor:pointer;" v-for="(searchResult,index) in searchResults" :key='index'>
        ...
        <div v-if="!searchShow">
            <li  @click="playOnline(onlineList)" style="cursor:pointer;" v-for="(onlineList,index) in onlineLists" :key='index'>
